...
<center>
<h2><font color="orange">AMOUNT DEPOSIT</font></h2>
</center>
<div id="mainDiv">
<form action="amtDepositValidate" method="post">
<fieldset style="padding-left: 180px;width:  500px;">
   ...
   <label class="mandatory">*</label><label><b>Acc Num:</b></label>&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <input type="text" name="amtDeposit" id="amtDeposit" required></input><pre></pre>	
